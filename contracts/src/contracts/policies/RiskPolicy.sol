...
///
///      No access control: unlike SanctionRegistry and ComplianceOracle, this contract has nothing
///      to authorize. It is a pure function of its inputs, so it stays outside the AccessManager the
