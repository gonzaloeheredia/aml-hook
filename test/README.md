...
| Wallet E first swap (API or frontend) | Fund from **C** first. Bag under $1,000 → **3%**; bag $10k + $1k swap → **8%** (A mid); bag ≥ $15k + small swap → **8%** (D); this swap ≥ $15,000 → **REVERT**; 24h cross → **DailyAggregationBlocked**; unbound feed → **MagnitudeQuoteFailed** |
